...
@CrossOrigin(origins = "http://localhost:4200")//angular jab request kar tha hai tha ya deline kar tha hai
...
public class PatientController {
	...
	@PostMapping("/patients")//data store kar na kaliya rest api banya ga
